<?php
    ...
    // construct the SQL query to select all products from the "product" table that have "ProductCategory" value of "Mens clothes"
    $sql = "SELECT * FROM product WHERE ProductCategory='Mens clothes'";

    // execute the SQL query using the mysqli_query() function and store the result in a variable called $all_mensproducts
    $all_mensproducts = mysqli_query($conn, $sql);
?>
<?php
...
<div class="products" style="margin-top:11%">
    ...
    <div class="productcontainer">
        ...
        <h1 class="lg-title">Men's clothing</h1>
        
        <!-- A short description for the product category -->
        <p class="text-light">View all Men's clothing supplied by the Sneaker Syndicate.</p>
