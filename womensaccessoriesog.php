<?php
    ...
    $sql = "SELECT * FROM product WHERE ProductCategory='Womens accessories'";
    $all_womensaccessories = mysqli_query($conn, $sql);
...
<div class="products" style="margin-top:11%">
    <div class="productcontainer">
        ...
        <div class="product-items">         
            <!-- single product -->
            <?php
                while($row = mysqli_fetch_assoc($all_womensaccessories)){
             ?>
            <div class="product">
                <div class="product-content" id="<?php echo $row["ProductBrand"]?>" style="background: url('<?php echo $row["ImgLink"];?>1.jpg');background-size:cover;background-repeat:no-repeat;background-position: center center;">
                    ...
                    <div class="product-btns">
                        <button type="button" class="btn-cart">
                            <a href="womensaccessoriesproductpage.php?ProductID=<?php echo $row['ProductID']?>" style="color:#fff;">view item</a>
