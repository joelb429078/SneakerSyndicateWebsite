...
if(isset($_GET{'ProductID'})){ // if within the 
    ...
    header('Location: womensproductsog.php');
}
...
?>
        ...
        <div class="indvproduct-details" style="margin-top: 15%;">
            ...
            <div class="indvproduct-text">
                <!--category-->
                <span class="indvproduct-category">Colourway: <?php echo $row["Colourway"];?></span>  <!-- loads appropiate colourway of selected item-->
                <h3><?php echo $row["ProductBrand"];?> <?php echo $row["ProductName"];?></h3> <!-- loads name of selected item-->
                <span class="indvproduct-price">£<?php echo $row["ProductPrice"];?></span> <!-- loads appropiate colourway of selected item-->
                <p>
                    This is <?php echo $row["ProductBrand"];?> <?php echo $row["ProductName"];?> comes in a <?php echo $row["Colourway"];?> colourway. <!-- Uses specific -->
                    <br />
    ...
    <!-- Initialize Swiper -->
    <script>
        // accessing all div elemetns and setting them as variables 
        ...
        function prodinforeveal() { // adjusts CSS styling of all div elements to show product information 
        ...
        function deliveryreveal() { // adjusts CSS styling of all div elements to show delivery information 
        ...
        function returnsreveal() { // adjusts CSS styling of all div elements to show return information 
        ...
        function reviewsreveal() { // adjusts CSS styling of all div elements to show delivery information 
        ...
        // Initialize a new instance of the Swiper object with the class "mySwiper"
        var swiper = new Swiper(".mySwiper", {

          // Display one slide at a time
          slidesPerView: 1,

          // Add a space of 10 pixels between slides
          spaceBetween: 10,

          // Add navigation buttons to the swiper
          navigation: {
          ...
          breakpoints: {
            ...
            // If the screen size is at least 450 pixels wide,
            // display two slides at a time with no space between them
            450: {
              slidesPerView: 2,
              spaceBetween: 0,
            },

            // If the screen size is at least 820 pixels wide,
            // display one slide at a time with no space between them
            820: {
              slidesPerView: 1,
              spaceBetween: 0,
            },

            // If the screen size is at least 1024 pixels wide,
            // display two slides at a time with no space between them
            1024: {
              slidesPerView: 2,
              spaceBetween: 0,
        ...
        // When a checkbox with class "s-checkbox" changes,
        // uncheck all other checkboxes with class "s-checkbox"
