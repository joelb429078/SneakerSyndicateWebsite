<?php
    ...
    $sql = "SELECT * FROM product WHERE ProductCategory='Kids accessories'";
    $all_kidaccessories = mysqli_query($conn, $sql);
?>
<?php
...
<div class="products" style="margin-top:11%">
    ...
    <div class="productcontainer">
        ...
        <h1 class="lg-title">Kids accessories</h1>
        
        <!-- A short description for the product category -->
        <p class="text-light">View all Kids accessories supplied by the Sneaker Syndicate.</p>
