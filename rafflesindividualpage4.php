    ...
    <section id="product-page" style="margin-top: 15%; ">
        <div class="raffleprodcont" style="max-width: 1500px; width: 90%; display: grid; grid-template-columns: 2fr 1fr; margin: 50px auto; box-shadow: -1px 3px 91px -30px rgb(0 0 0 / 47%);">
                ...
                <div class="row">
                    <div class="raffleimage-container">
                        <div class="quarterimage" style="display: grid; grid-template-columns: repeat(2, 1fr);">
                            <img src="img/raffle/shoe4/airjordan5-1.png" alt="" class="featured-image-4" style="width: 100%; padding: 20px;">
                            <img src="img/raffle/shoe4/airjordan5-2.png" alt="" class="featured-image-4" style="width: 100%; padding: 20px;">
                            <img src="img/raffle/shoe4/airjordan5-3.png" alt="" class="featured-image-4" style="width: 100%; padding: 20px;">
                            <img src="img/raffle/shoe4/airjordan5-4.png" alt="" class="featured-image-4" style="width: 100%; padding: 20px;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="raffleprodconttext" style="background-color: #ffffff; padding: 60px; position: relative; ">
                ...
                <h3 style=" color: #252525; font-size: 4.2rem; font-weight: 600; margin: 10px 0px;">Air Jordan 5</h3>
                <span class="indvproduct-price" style=" font-size: 2rem; color: #252525; font-weight: 500;">£189.95</span>
                <p style="margin: 30px 0px; color: #5e5e5e; letter-spacing: 1px; font-size: 1.2rem; ">
                    Care for a swim? The finishing touch to all your favourite 'fits returns with the AJ-5 "Aqua". Paying homage to the coveted AJ-8 colourway from '93, energetic pops of Aqua and Taxi pulse against a Black backdrop. Flawless details from the original like the spiky midsole, side vents and lace lock tie it all together, giving these incredible kicks that look you love. Dive on in—the water's fine.
