<?php
    ...
    $sql = "SELECT * FROM product WHERE ProductCategory='shoes'";
    $all_shoes = mysqli_query($conn, $sql);
...
<div class="products" style="margin-top:11%">
    ...
    <div class="productcontainer">
        ...
        <h1 class="lg-title">Footwear</h1>
        
        <!-- A short description for the product category -->
        <p class="text-light">View all Footwear supplied by the Sneaker Syndicate.</p>
