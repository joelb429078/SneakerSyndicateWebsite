    ...
    <section id="product-page" style="margin-top: 15%; ">
        <div class="raffleprodcont" style="max-width: 1500px; width: 90%; display: grid; grid-template-columns: 2fr 1fr; margin: 50px auto; box-shadow: -1px 3px 91px -30px rgb(0 0 0 / 47%);">
                ...
                <div class="row">
                    <div class="raffleimage-container">
                        <div class="quarterimage" style="display: grid; grid-template-columns: repeat(2, 1fr);">
                            <img src="img/raffle/shoe2/airjordan2-1.png" alt="" class="featured-image-4" style="width: 100%; padding: 20px;">
                            <img src="img/raffle/shoe2/airjordan2-2.png" alt="" class="featured-image-4" style="width: 100%; padding: 20px;">
                            <img src="img/raffle/shoe2/airjordan2-3.png" alt="" class="featured-image-4" style="width: 100%; padding: 20px;">
                            <img src="img/raffle/shoe2/airjordan2-4.png" alt="" class="featured-image-4" style="width: 100%; padding: 20px;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="raffleprodconttext" style="background-color: #ffffff; padding: 60px; position: relative; ">
                ...
                <h3 style=" color: #252525; font-size: 4.2rem; font-weight: 600; margin: 10px 0px;">Air Jordan 2</h3>
                <span class="indvproduct-price" style=" font-size: 2rem; color: #252525; font-weight: 500;">£169.95</span>
                <p style="margin: 30px 0px; color: #5e5e5e; letter-spacing: 1px; font-size: 1.2rem; ">
                    Subdued, palate-cleansing, substantial. The classic high tops that set the stage for a footwear dynasty return in a brand-new colourway. Highlights of Lucky Green pulse against crisp White, taking cues from the first AJ-2's colour-blocking. Faux lizard skin, sleek lines and no Swoosh keep the minimalist elegance and refined look of the original. 
